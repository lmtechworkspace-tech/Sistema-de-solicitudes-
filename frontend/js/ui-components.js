...
function renderHeaderSigso(paginaActiva) {
  ...
  contenedor.innerHTML =
    ...
    // v13: la marca lleva a la pagina de presentacion (landing.html). Antes
    // no era un enlace y la landing quedaba inalcanzable: existia publicada
    // pero NINGUNA pagina apuntaba a ella. Va en la marca y no como un item
    // mas del nav a proposito -- el nav son destinos de TRABAJO (solicitar,
    // consultar, backoffice) y sumarle una pagina de presentacion los
    // diluiria; "el logo lleva a la portada" es la convencion que la gente
    // ya trae aprendida.
    '<a class="sigso-header__marca" href="' + sitioPublico + 'landing.html">' +
    MARCA_SIGSO_SVG +
    '<div>' +
